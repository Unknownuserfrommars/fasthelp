...
class GetVersionInfo:
    def __init__(self):
        self._versionInfoMessage = "You are using FastHelp version 1.0.27, developed by JDT."
    def print(self):
...
class DataHelper:
    class new:
        def __init__(self, data_type, save_name: str):
            """
            You are using `DataHelper.new()`, developed by JDT, version 0.10.2.
    ...
    class totype:
        def DataFrame(self, dataset) -> pd.DataFrame:
            """
        ...
        def npArray(self, dataset) -> np.ndarray:
            """
...
class FileHelper:
    class Open:
        ...
        def Opencsv(self, filepath: str, sep: str=None, delimiter: str=None, header: str=None, index_col: int|str=None) -> pd.DataFrame:
            """
        ...
        def Openexcel(self, filename: str, sheet_name: list | int, index_col: int=None) -> pd.DataFrame:
            """
    ...
    class Create:
        def Createtxt(filename: str, savepath: str):
            raise NotImplementedError("This is simple to create but will not be created in this version. We expect a first release of this function in an Insider Version.")
        
        def CreateDocument(filename: str, savepath: str, suffix: str=".docx", title: str=None, heading_1: str=None, heading_2: str=None, heading_3: str=None, heading_4: str=None, heading_5: str=None, heading_6: str=None, heading_7: str=None, heading_8: str=None, heading_9: str=None, table_rows: int=None, table_cols: int=None, content: list=None):
            """
        ...
        def CreatePresentation(filename: str, savepath: str, suffix: str='.pptx', total_slides: int=1):
            """
...
class StringHelper:
    ...
    def capitalize_letters(self, text: str, letters: list | str) -> str:
        """
        You are using `StringHelper.capitalize_letters()`, developed by JDT and ElectroBL, version 0.2.18.
    ...
    def lower_letters(self, text: str, letters: list | str) -> str:
        """
