...
class _GetVersionInfo:
    def __init__(self):
        self._versionInfoMessage = "You are using FastHelp version 1.0.13, developed by JDT."
    def print(self):
...
class future:
    ...
    class Full_Open_File:
        def __init__(self, **kwargs):
            raise NotImplementedError("Sorry, this module hadn't been implemented yet. Scheduled Implement Version (SIV): 1.1.2 or 1.0.19, depending on JDT's requests.")
...
class FileHelper:
    class Open:
        ...
        def Opentxt(self, file, name=None):
            """
            You are using `FileHelper.Open.Opentxt()`, developed by JDT, version 0.2.16.
        ...
        def txt(self, file, name=None):
            """Wrapper function for `Opentxt()`, version 0.5.1."""
            if name:
                return Opentxt(file=file, name=name)  # type: ignore # noqa: F821
            else:
                return Opentxt(file=file)  # type: ignore # noqa: F821
            
        def Opencsv(self, file, sep=None, delimiter=None, header=None, index_col=None):
            """
            You are using `FileHelper.Open.Opencsv()`, developed by JDT, version 0.6.0.
...
class StringHelper:
    def Upper(self, string: str) -> str:
        """
        You are using `StringHelper.Upper()`, developed by JDT, version 0.4.1.
    ...
    def capitalize_letters(self, text: str, letters) -> str:
        """
        You are using `StringHelper.capitalize_letters()`, developed by JDT and ElectroBL, version 0.2.12.
    ...
    def lower_letters(self, text: str, letters) -> str:
        """
        You are using `StringHelper.lower_letters()`, developed by JDT, version 0.1.5.
...
class JavaHelper:
    ...
    def run(self):
        """
        You are using `JavaHelper.run()`, developed by JDT, version 0.4.10.
...
class FolderHelper:
    ...
    def new_fldr(self, name):
        """
        You are using `FolderHelper.new_fldr()`, developed by JDT, version 0.3.4
    ...
    def new_file(self, type='text', open_in_vscode=False, filename='new_file'):
        """
        You are using `FolderHelper.new_file()`, developed by JDT and ElectroBL, version 0.12.7.
        
        Parameters:
        - type (`str`): The type of file to create ('text'/'py'/'java'/'js'/'c'/'cpp'/'r'). Default is 'text'.
        ...
        if type not in extensions:
            print("Unsupported file type. Supported types are: 'text', 'py', 'java', 'js', 'c', 'cpp', 'r'.")
            return
...
class IDEHelper:
    ...
    class PyCharm:
        def __init__(self, file=None):
            """
            You are using `IDEHelper.PyCharm.__init__()`, developed by JDT, version 0.4.18.
    ...
    class IntelliJ:
        def __init__(self, file=None):
            """
            You are using `IDEHelper.IntelliJ.__init__()`, developed by JDT, version 0.4.6.
    ...
    class VisualStudio_2019:
        def __init__(self, file=None):
            """
            You are using `IDEHelper.VisualStudio_2019.__init__()`, developed by JDT, version 0.4.3.
    ...
    class RStudio:
        def __init__(self, file=None):
            ...
            This is safe to use.
            Without specifying as 'safe-to-use', all other modules should be used at the users own risk.
            You are using `IDEHelper.RStudio.__init__()`, developed by JDT, version 0.3.9.
        ...
        def get_version(self):
            """
            You are using `IDEHelper.RStudio.get_version()`, developed by JDT, version 0.2.5.
            
            Parameter:
            None
            
            Returns:
            `str`: Version of RStudio
            """
            try:
                result = subprocess.run(['rstudio', '--version'], check=True, stdout=subprocess.PIPE, text=True)
                version_info = result.stdout.splitlines()[0]
                return f"RStudio {version_info}"
            except subprocess.CalledProcessError as e:
                return f"Error retrieving RStudio version: {e}"
    ...
    class PyIDLE:
        def __init__(self, file=None):
            ...
            Without specifying as 'safe-to-use', all other modules should be used at the users own risk.
            You are using `IDEHelper.PyIDLE.__init__()`, developed by JDT, version 0.9.6.
        ...
        def get_version(self):
            """
            You are using `IDEHelper.PyIDLE.get_version()`, developed by JDT, version 0.1.0
