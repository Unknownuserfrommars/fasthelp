...
class GetVersionInfo:
    def __init__(self):
        self._versionInfoMessage = "You are using FastHelp version 1.1.0, developed by FastHelp Dev Team. Original framework made by by JDT."
    def print(self):
...
class StringHelper:
    ...
    def Upper(s: str) -> str:
        """
        You are using `StringHelper.Upper()`, developed by JDT, version 0.4.8.
    ...
    @staticmethod
    def capitalize_letters(text: str, 
